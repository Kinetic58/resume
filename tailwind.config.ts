	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { 
						'text-shadow': '0 0 5px rgba(14, 165, 233, 0.5), 0 0 15px rgba(14, 165, 233, 0.3), 0 0 20px rgba(14, 165, 233, 0.2)'
					},
					'50%': { 
						'text-shadow': '0 0 10px rgba(14, 165, 233, 0.8), 0 0 20px rgba(14, 165, 233, 0.5), 0 0 30px rgba(14, 165, 233, 0.3)'
					}
				},
				'pulse-border': {
